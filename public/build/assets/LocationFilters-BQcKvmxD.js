import{n as e,t}from"./jsx-runtime-I8uHACss.js";import{n,s as r}from"./fi-21qp7GTt.js";var i=e(),a=t();function o(e){let t=(0,i.c)(14),{status:o,setStatus:s,sortAsc:c,setSortAsc:l}=e,u;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(u=[`en_cours`,`expiré`],t[0]=u):u=t[0];let d=u,f;t[1]===Symbol.for(`react.memo_cache_sentinel`)?(f=(0,a.jsxs)(`button`,{type:`button`,className:`
                        flex
                        items-center
                        justify-center
                        gap-2
                ...
                `,children:d.map(e=>(0,a.jsx)(`button`,{type:`button`,onClick:()=>s(e),className:`
                            ...
                            ${o===e?`bg-white text-[#00647c] shadow-sm`:`text-[#334155] hover:text-[#00647c]`}
