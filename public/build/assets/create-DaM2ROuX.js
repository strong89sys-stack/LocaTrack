import{t as e}from"./jsx-runtime-B-hcVAMW.js";import{t}from"./compiler-runtime-kM0e9lBH.js";import{t as n}from"./loader-circle-CCkVCjNd.js";import{L as r,z as i}from"./app-BwpkRVN-.js";var a=t(),o=e();function s(){let e=(0,a.c)(77),t;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t={nom:``,prenoms:``,email:``,telephone:``,adresse:``},e[0]=t):t=e[0];let{data:i,setData:s,post:u,processing:d,errors:f}=r(t),p;e[1]===u?p=e[2]:(p=e=>{e.preventDefault(),u(`/clients/create`,{onSuccess:l})},e[1]=u,e[2]=p);let m=p,h=c,g;e[3]===Symbol.for(`react.memo_cache_sentinel`)?(g=(0,o.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,o.jsxs)(`div`,{className:`mb-8`,children:[(0,o.jsx)(`h1`,{className:`text-3xl font-semibold tracking-tight text-gray-900 dark:text-white`,children:`Ajouter un client`}),(0,o.jsx)(`p`,{className:`mt-2 text-sm text-gray-500 dark:text-gray-400`,children:`Enregistrez un nouveau client dans votre plateforme.`})]}),(0,o.jsx)(`button`,{onClick:h,className:`font-bold hover:underline transition-all`,children:`Retour`})]}),e[3]=g):g=e[3];let _;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(_=(0,o.jsx)(`label`,{htmlFor:`nom`,className:`
                                        mb-2 block
                                        text-sm font-medium
                                        text-gray-900
                                        dark:text-gray-200
                                    `,children:`Nom`}),e[4]=_):_=e[4];let v;e[5]===s?v=e[6]:(v=e=>s(`nom`,e.target.value),e[5]=s,e[6]=v);let y;e[7]!==i.nom||e[8]!==v?(y=(0,o.jsx)(`input`,{id:`nom`,type:`text`,value:i.nom,onChange:v,placeholder:`Ex : Kaboré`,className:`
                                        w-full rounded-lg
                                        ...
                                        dark:bg-zinc-900
                                        dark:text-white
                                    `}),e[7]=i.nom,e[8]=v,e[9]=y):y=e[9];let b;e[10]===f.nom?b=e[11]:(b=f.nom&&(0,o.jsx)(`p`,{className:`mt-2 text-sm text-red-500`,children:f.nom}),e[10]=f.nom,e[11]=b);let x;e[12]!==y||e[13]!==b?(x=(0,o.jsxs)(`div`,{children:[_,y,b]}),e[12]=y,e[13]=b,e[14]=x):x=e[14];let S;e[15]===Symbol.for(`react.memo_cache_sentinel`)?(S=(0,o.jsx)(`label`,{htmlFor:`prenoms`,className:`
                                        mb-2 block
                                        text-sm font-medium
                                        text-gray-900
                                        dark:text-gray-200
                                    `,children:`Prénoms`}),e[15]=S):S=e[15];let C;e[16]===s?C=e[17]:(C=e=>s(`prenoms`,e.target.value),e[16]=s,e[17]=C);let w;e[18]!==i.prenoms||e[19]!==C?(w=(0,o.jsx)(`input`,{id:`prenoms`,type:`text`,value:i.prenoms,onChange:C,placeholder:`Ex : Aziz`,className:`
                                        w-full rounded-lg
                                        border border-gray-300
                                        bg-white
                                        px-4 py-3
                                ...
                                `,children:`Adresse e-mail`}),e[29]=O):O=e[29];let k;e[30]===s?k=e[31]:(k=e=>s(`email`,e.target.value),e[30]=s,e[31]=k);let A;e[32]!==i.email||e[33]!==k?(A=(0,o.jsx)(`input`,{id:`email`,type:`email`,value:i.email,onChange:k,placeholder:`Ex : client@example.com`,className:`
                                    ...
                                    dark:bg-zinc-900
                                    dark:text-white
                                `}),e[32]=i.email,e[33]=k,e[34]=A):A=e[34];let j;e[35]===f.email?j=e[36]:(j=f.email&&(0,o.jsx)(`p`,{className:`mt-2 text-sm text-red-500`,children:f.email}),e[35]=f.email,e[36]=j);let M;e[37]!==A||e[38]!==j?(M=(0,o.jsxs)(`div`,{children:[O,A,j]}),e[37]=A,e[38]=j,e[39]=M):M=e[39];let N;e[40]===Symbol.for(`react.memo_cache_sentinel`)?(N=(0,o.jsx)(`label`,{htmlFor:`telephone`,className:`
                                    mb-2 block
                                    text-sm font-medium
                                    text-gray-900
                                    dark:text-gray-200
                                `,children:`Téléphone`}),e[40]=N):N=e[40];let P;e[41]===s?P=e[42]:(P=e=>s(`telephone`,e.target.value),e[41]=s,e[42]=P);let F;e[43]!==i.telephone||e[44]!==P?(F=(0,o.jsx)(`input`,{id:`telephone`,type:`tel`,value:i.telephone,onChange:P,placeholder:`Ex : +225 07 00 00 00 00`,className:`
                                    w-full rounded-lg
                                    border border-gray-300
                                    bg-white
                                    px-4 py-3
                                    ...
                                    dark:bg-zinc-900
                                    dark:text-white
                                `}),e[43]=i.telephone,e[44]=P,e[45]=F):F=e[45];let I;e[46]===f.telephone?I=e[47]:(I=f.telephone&&(0,o.jsx)(`p`,{className:`mt-2 text-sm text-red-500`,children:f.telephone}),e[46]=f.telephone,e[47]=I);let L;e[48]!==F||e[49]!==I?(L=(0,o.jsxs)(`div`,{children:[N,F,I]}),e[48]=F,e[49]=I,e[50]=L):L=e[50];let R;e[51]===Symbol.for(`react.memo_cache_sentinel`)?(R=(0,o.jsx)(`label`,{htmlFor:`adresse`,className:`
                                    mb-2 block
                                    text-sm font-medium
                                    text-gray-900
                                    dark:text-gray-200
                                `,children:`Adresse`}),e[51]=R):R=e[51];let z;e[52]===s?z=e[53]:(z=e=>s(`adresse`,e.target.value),e[52]=s,e[53]=z);let B;e[54]!==i.adresse||e[55]!==z?(B=(0,o.jsx)(`input`,{id:`adresse`,type:`text`,value:i.adresse,onChange:z,placeholder:`Ex : Cocody, Abidjan`,className:`
                                    w-full rounded-lg
                                    border border-gray-300
                                    bg-white
                                    px-4 py-3
