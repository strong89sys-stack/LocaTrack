...
export default function Aside({ equipements, onSelect }: AsideProps) {
    ...
    return (
        <aside className="order-2 flex h-[45vh] min-h-0 w-full flex-col border-t border-gray-200 bg-[#f8f9ff] lg:order-0 lg:col-span-3 lg:h-screen lg:w-auto lg:border-t-0 lg:border-l">
            <div className="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white px-5 py-4 sm:px-6 lg:py-5">
                <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400">Suivi en temps réel</p>
                    <h2 className="mt-1 text-xl font-bold text-[#121c28]">État du parc</h2>
                </div>
                    ...
                    {equipementsState.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full rounded-2xl border border-gray-200 border-l-[5px] bg-white p-4 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${offline ? "border-l-red-500" : "border-l-[#00647c]"}`}
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <div className={`shrink-0 rounded-full px-2.5 py-1 text-[11px] font-semibold ${offline ? "bg-red-50 text-red-500" : "bg-[#00647c]/10 text-[#00647c]"}`}>
                                ...
                                <div className="mt-4 grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                                    <div className="rounded-xl bg-gray-50 p-3">
                                        ...
                                        <p className="mt-1 text-sm font-bold text-[#121c28]">
                                    ...
                                    <div className="col-span-2 rounded-xl bg-gray-50 p-3">
                                        ...
                                        <p className="mt-1 truncate text-sm font-semibold text-[#121c28]">
